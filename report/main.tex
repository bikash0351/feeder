...
\begin{enumerate}
    ...
    \item To evaluate and compare the performance of ML and DL models using standard error metrics (e.g., RMSE, MAPE, MAE, R-squared).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{loadByHour.png}
    \caption{Average Load by Hour of Day}
    \label{fig:load_by_hour}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{tempLoad.png}
    \caption{Air Temperature vs Load}
    \label{fig:temp_load}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{humandityLoad.png}
    \caption{Load vs Humidity}
    \label{fig:humidity_load}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{solarLoad.png}
    \caption{Solar Radiation vs Load}
